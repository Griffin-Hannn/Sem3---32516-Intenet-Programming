...
export default function TodoApp() {
  ...
  // Write your code here to define token and username states, and initialize them from localStorage...
  // ...
        ...
        const response = await fetch(API_BASE_URL, {
          ...
          headers: {
            'Content-Type': 'application/json',
              // add the token to the Authorization header for authenticated 
              // Write your code here...requests
          },
          body: JSON.stringify({
