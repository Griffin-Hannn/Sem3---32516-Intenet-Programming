...
class Todo(SQLModel, table=True):
    # Since PostgreSQL table design here uses a string id for compatibility with the app,
...
# Create the database and table as specified by DATABASE_URL and the Todo class
# (the class can be used to create a db table because of this argument configuration: 'table=True').
...
# # the get_all_todos endpoint calls this function to fetch multiple records (limited to 100 records per fetch)
